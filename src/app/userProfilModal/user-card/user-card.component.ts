...
export class UserCardComponent implements OnInit {
  ...
  imageURL = "http://localhost:8080/users/";
  userProfilURL = "http://localhost:8080/users/" + this.user.id + "/profil";
  ...
  ngOnInit(): void {
    ...
    this.getUserPicture(this.imageURL + this.user.id + "/picture").subscribe(
      (data: Blob) => {
