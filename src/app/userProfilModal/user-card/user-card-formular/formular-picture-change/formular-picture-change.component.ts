...
@Component({
  selector: 'app-formular-picture-change',
  templateUrl: './formular-picture-change.component.html',
  styleUrls: ['./formular-picture-change.component.scss'],
  ...
  providers: [
    {
      ...
      useExisting: FormularPictureChangeComponent, /*Indique à Angular que FileUploadComponent implémente l'interface NG_VALUE_ACCESSOR, et que cette implémentation doit être utilisée pour communiquer avec les modèles de formulaire.*/
...
export class FormularPictureChangeComponent {
